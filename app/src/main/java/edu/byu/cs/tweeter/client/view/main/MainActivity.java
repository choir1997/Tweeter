...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.View {
        ...
        followButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (followButton.getText().toString().equals(v.getContext().getString(R.string.following))) {
                    presenter.getUnfollow(selectedUser);
                } else {
                    presenter.getFollow(selectedUser);
                }
            }
        });
    }
    ...
    public void updateSelectedUserFollowingAndFollowers() {
        ...
        presenter.getFollowerAndFollowingCount(selectedUser);
    ...
    @Override
    public void setCountText(int count, boolean setFollowerCount) {
        if (setFollowerCount) {
    ...
    @Override
    public void changeToIsFollowerButton() {
        followButton.setText(R.string.following);
        followButton.setBackgroundColor(getResources().getColor(R.color.white));
        followButton.setTextColor(getResources().getColor(R.color.lightGray));
    }
    ...
    @Override
    public void changeToIsNotFollowerButton() {
        followButton.setText(R.string.follow);
        followButton.setBackgroundColor(getResources().getColor(R.color.colorAccent));
    }

    @Override
    public void updateFollowInfo(boolean value) {
        updateSelectedUserFollowingAndFollowers();
